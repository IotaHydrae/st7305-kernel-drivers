...
static const struct of_device_id st7735r_of_match[] = {
	...
	{ .compatible = "wlk,w290hc019mono-12z", .data = &jd_t18003_t01_cfg },
...
static const struct spi_device_id st7735r_id[] = {
	...
	{ "w290hc019mono-12z", (uintptr_t)&jd_t18003_t01_cfg },
...
static int st7735r_probe(struct spi_device *spi)
{
	...
	priv = devm_drm_dev_alloc(dev, &st7735r_driver, struct st7735r_priv,
				  dbidev.drm);
	if (IS_ERR(priv))
		return PTR_ERR(priv);
